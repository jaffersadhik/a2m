...
public class MemoryLoaderLog {


    private static final  Logger logger = Logger.getLogger(MemoryLoaderLog.class.getName());
    ...
    static {
         ...
         String folderName="/opt/jboss/wildfly/logs/";
         FolderCreation.foldercreaton(folderName);
         String logFileNamePattern = folderName+"memoryloader.%g.log";
