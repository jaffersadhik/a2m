...
public class StartupTimeLog {


    private static final  Logger logger = Logger.getLogger(StartupTimeLog.class.getName());
    ...
    static {
        ...
        String logFileNamePattern = "/opt/jboss/wildfly/logs/startuptime.%g.log";
