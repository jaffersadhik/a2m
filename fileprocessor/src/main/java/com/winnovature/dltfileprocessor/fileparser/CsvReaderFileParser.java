...
public class CsvReaderFileParser implements FileParser {
    ...
    public long parse() throws Exception {
        ...
        try {
            ...
            // Updated CSVWriter initialization for OpenCSV 5.9
            csvWriter = (CSVWriter) new CSVWriterBuilder(new FileWriter(failedDataFile, true))
                    .withSeparator(delim)
            ...
            if (csvReader != null) {
                try {
                    ...
                    log.error(loggerName + "Error closing CSVReader", e);
                }
            }
            if (csvWriter != null) {
                try {
                    ...
                    log.error(loggerName + "Error closing CSVWriter", e);
                }
            }
        }
