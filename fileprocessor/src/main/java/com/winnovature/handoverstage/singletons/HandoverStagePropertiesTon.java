package com.winnovature.handoverstage.singletons;
...
public class HandoverStagePropertiesTon {

	static Log log = LogFactory.getLog(Constants.HandoverStageLogger);

	private static HandoverStagePropertiesTon singleton = new HandoverStagePropertiesTon();
	private PropertiesConfiguration propConf;
	static final String propertyFileLookupKey = "handover.stage.properties.loc";
	private String className = "HandoverStagePropertiesTon";

	private HandoverStagePropertiesTon() {
	}

	public static HandoverStagePropertiesTon getInstance() {
		return singleton;
	}
