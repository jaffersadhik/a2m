...
public class JndiPropertiesTon {

	static Log log = LogFactory.getLog(Constants.UtilsLogger);

	private static JndiPropertiesTon singleton = new JndiPropertiesTon();
	private PropertiesConfiguration propConf;
	static final String propertyFileLookupKey = "jndi.properties.loc";
	private String className = "JndiPropertiesTon";

	private JndiPropertiesTon() {
	}

	public static JndiPropertiesTon getInstance() {
		return singleton;
	}
