...
public class Kafka2ESJSONUtil
{
            ...
            IMessage iMsg)
    {
        ...
        subJSON.put(StartApplicationDelivery.ESIndexUniqueColumn, msgId);

        final String dataUpdTime = DateTimeUtility.getFormattedCurrentDateTime(DateTimeFormat.DEFAULT);
        subJSON.put(StartApplicationDelivery.ESDocUpdTmColumn, dataUpdTime);

        for (final ESIndexColMapValue esColMap : StartApplicationDelivery.ListESColMap)
        {
            ...
            String baseMsgId)
    {
        ...
        fmsgJSON.put(StartApplicationDelivery.ESFmsgIndexUniqueColumn, baseMsgId);
            ...
            IMessage iMsg)
    {
        ...
        delJSON.put(StartApplicationDelivery.ESIndexUniqueColumn, msgId);

        final String dataUpdTime = DateTimeUtility.getFormattedCurrentDateTime(DateTimeFormat.DEFAULT);
        delJSON.put(StartApplicationDelivery.ESDocUpdTmColumn, dataUpdTime);
