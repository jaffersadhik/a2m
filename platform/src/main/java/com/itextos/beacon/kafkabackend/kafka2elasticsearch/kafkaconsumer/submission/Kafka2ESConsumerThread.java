...
import com.itextos.beacon.kafkabackend.kafka2elasticsearch.start.StartApplicationSubmission;
        ...
        ConsumerRebalanceListener
{
    ...
    public Kafka2ESConsumerThread(
        ...
        this.ConsumerMode = "submission";
        this.AppConfig = StartApplicationSubmission.AppConfig;
        this.ESIndexName = StartApplicationSubmission.ESIndexName;
        this.ESIndexUniqueColumn = StartApplicationSubmission.ESIndexUniqueColumn;
        this.ESFmsgIndexName = StartApplicationSubmission.ESFmsgIndexName;
        this.ESFmsgIndexUniqueColumn = StartApplicationSubmission.ESFmsgIndexUniqueColumn;
        ...
        ConsumerClientID = StartApplicationSubmission.HostIPAddr + ":"
                + StartApplicationSubmission.AppProcID + ":"
                + pThreadName;
    }
        ...
        for (final ConsumerRecord<String, IMessage> data : pDataList) {
            ...
            BulkOperation updateOp = BulkOperation.of(b -> b
                .update(u -> u
                    ...
                    .action(a -> a
                        .docAsUpsert(true)
                        .doc(convertJSONObjectToMap(dataJSON))
                    )
                ...
                if (fmsgJSON != null) {
                    ...
                    BulkOperation fmsgUpdateOp = BulkOperation.of(b -> b
                        .update(u -> u
                            ...
                            .action(a -> a
                                .docAsUpsert(true)
                                .doc(convertJSONObjectToMap(fmsgJSON))
                            )
                            .retryOnConflict(ESRetryConflictCount)
                        )
                    );
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                StartApplicationSubmission.logMsg("Total records processed: " + ProcCount);
                StartApplicationSubmission.logMsg("Consumer Thread stopped");
    ...
    public void stopConsumer() {
        if (stopped.get())
            return;
        stopped.set(true);
        StartApplicationSubmission.logMsg("Stop Flag has been set");
