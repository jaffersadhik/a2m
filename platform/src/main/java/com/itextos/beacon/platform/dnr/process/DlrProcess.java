...
public class DlrProcess
{
    ...
    public static String doProcess(
            Map<String,String> aDLRRequest)
    {

        try
        {
            if (log.isDebugEnabled())
                log.debug("DLR QueryString from Carrier - " + aDLRRequest);

            final String lDr       = aDLRRequest.get("dr");
            final String lSmscid   = aDLRRequest.get("smscid");
            final String lAddInfo  = aDLRRequest.get("add_info");
            final String lSystemid = aDLRRequest.get("systemid");
            final String lStatuscd = aDLRRequest.get("statuscd");
            final String lCarrierAcknowledgeId = aDLRRequest.get("carrierackid");
