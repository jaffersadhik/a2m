...
public class Gateway {
    ...
    public List<SmscBean> getSMSCS() {
        ...
        for (int index = 0; index < smscCount; index++) {
            ...
            try {
                ...
                log.error("Exception while getting the Smsc Failed Count", e);
            }
            ...
            try {
                ...
                log.error("Exception while getting the Smsc Dn Count", e);
            }
    ...
    public long getSMSBoxQueued() {
        try {
            ...
            log.error("Exception while getting the Box Type", e);
            return -1;
        }
