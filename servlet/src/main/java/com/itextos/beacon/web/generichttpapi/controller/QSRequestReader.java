...
public class QSRequestReader {
	...
	public String processRequest() throws Exception {
        ...
        QSReceiverLog.log("requestType : "+requestType);
		 ...
		 final RequestReader reader = new com.itextos.beacon.interfaces.generichttpapi.processor.reader.QSRequestReader( params,  method,  requestType,stringBuffer);
	...
	public static void initSMS() throws Exception
	{
	    ...
	    QSRequestReader reactiveReader = new QSRequestReader(
