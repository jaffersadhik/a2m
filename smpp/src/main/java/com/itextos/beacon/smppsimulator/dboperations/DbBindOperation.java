package com.itextos.beacon.smppsimulator.dboperations;
...
import com.itextos.beacon.smppsimulator.objects.bind.BindInfoValid;
import com.itextos.beacon.smppsimulator.objects.bind.UnbindInfo;
import com.itextos.beacon.smppsimulator.utils.ItextosSmppUtil;
...
public class DbBindOperation
{
            ...
            throws SQLException
    {
        ...
        for (final ISmppInfo aSmppInfo : aISmppInfo)
        {
            ...
            aPstmt.setString(11, "Simulator : "+lBindInfo.getThreadName());
            ...
            throws SQLException
    {
        ...
        for (final ISmppInfo aSmppInfo : aISmppInfo)
        {
            ...
            aPstmt.setString(11, " Simulator : "+lUnBindInfo.getThreadName());
